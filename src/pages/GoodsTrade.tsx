...
const TradeCard = ({ trade }: { trade: TradeItem }) => (
  ...
  >
    {/* 상단 상태 및 위치 정보 - mb-4 추가로 본문과 간격 확보 */}
    <div className="p-5 pb-4 flex justify-between items-start mb-2">
    ...
    <div className="flex-1 px-5 space-y-2">
      {/* HAVE 섹션 - mb-2 추가 */}
      <div className="bg-indigo-50/50 rounded-xl border border-indigo-100 p-3.5 relative group-hover:bg-indigo-50 transition-colors mb-2">
      ...
      {/* WANT 섹션 - mb-2 추가 */}
      <div className="bg-pink-50/50 rounded-xl border border-pink-100 p-3.5 relative group-hover:bg-pink-50 transition-colors mb-2">
        <div className="flex items-center gap-2 mb-2.5">
...
export default function GoodsTrade() {
  ...
  return (
    <div className="max-w-7xl mx-auto p-4 md:p-8 space-y-8">
      ...
      {/* 1. 주의사항 (상단 배치) */}
      <div className="bg-orange-50/80 border border-orange-200/60 rounded-2xl p-4 flex items-start gap-4 shadow-sm backdrop-blur-sm mb-4">
      ...
      {/* 3. 필터 바 & 컨트롤 */}
      <div className="bg-white p-5 rounded-2xl border border-slate-100 shadow-sm flex flex-col lg:flex-row gap-5 mb-6">
